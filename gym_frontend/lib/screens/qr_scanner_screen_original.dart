...
class _QRScannerScreenState extends State<QRScannerScreen> {
    ...
    try {
      ...
      if (memberId != null) {
        ...
        _showErrorDialog('Invalid QR Code',
            'The scanned QR code is not recognized as a valid member code.');
      }
    } catch (e) {
  ...
  Future<void> _recordAttendance(int memberId) async {
    ...
    try {
      ...
      // Record attendance
      final success =
          await attendanceProvider.checkIn(memberId, member.fullName);
      ...
      _showErrorDialog(
          'Member Not Found', 'Member ID $memberId not found in the system.');
    }
  }
